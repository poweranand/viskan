<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddFestivalDetails.aspx.cs" Inherits="AddFestivalDetails" %>
                ...
                <td valign="top">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                &nbsp;<asp:TextBox ID="txtDuration" runat="server" Columns="100" Rows="5" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                         <tr>
                            <td>
