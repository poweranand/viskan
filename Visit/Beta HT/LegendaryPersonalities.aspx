<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="LegendaryPersonalities.aspx.cs" Inherits="HistoricalSpots" %>
...
<head id="Head1" runat="server">
    <title>Legendary Personalities</title>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="1000px">
                        ...
                        <tr>
                            <td style="background-image: url('Images/Linkbg.png'); background-position: center;
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td width="13%" style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                            <a href="index.aspx" class="links">Home</a>                                        </td>
										<td width="13%" style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                            <a href="aboutkanchipuram.html" class="links">Kanchi At A Glance</a>                                        </td>
                                        <td width="16%" style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                             <a href="HistoricalSpots.aspx" class="links">Historical Spots</a>                                        </td>
                                        
                                        <td width="18%" style="width: 20%; border-right: 1px solid #ffffff; text-align: center;">.
                                            <a href="LegendaryPersonalities.aspx" class="links" style="color: Yellow;">Legendary Personalities</a>                                        </td>
                                        <td width="13%" style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                            <a href="Festivals.aspx" class="links">Festivals</a>                                        </td>
                                        <td width="13%" style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                            <a href="touristinfo.html" class="links">Tourist Info</a>                                        </td>
                                        <td width="14%" style="width: 14%;  text-align: center;">
                        ...
                        <tr>
                            <td valign="top">
                                <table border="0" cellpadding="0" cellspacing="5" width="100%">
                                    <tr>
                                        <td style="width: 253px; background-image: url('Images/Search_LEGENDARY.png'); background-position: top;
