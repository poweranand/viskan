                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="1000px">
                            <tr>
                                <td>
									...
									<TR bgcolor="#3B3B3B" ><TD><div style="float:right;">
                                                                <a href="http://www.twitter.com/visitkanchi" target="_blank" name="" style="position:relative;"><img border="0" src="Images/twitter-c.png"alt="Follow visitkanchi on Twitter" title=""></a>
                                                            </div> 
                                                            <div style="float:right;">
                                                                <strong class="contentcenter txt" style="font-weight:bold; color:#FFFFFF;  text-align:inherit; font-size:13px;">Follow Us:</strong>    
                                      </div> </TD>  </TR>
									
                                        <tr>
                                            <td>
                                                <asp:Image ID="imgBanner" runat="server" Width="1000px" /></td>
                                        </tr>
                                        <tr style="height: 1px">
                                            <td>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="background-image: url('Images/Linkbg.png'); background-position: center;
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td style="width: 13%; border-right: 1px solid #ffffff; text-align: center; height: 16px;">
                                                            <a href="#" class="links" style="color: Yellow;">Home</a></td>
														<td style="width: 13%; border-right: 1px solid #ffffff; text-align: center; height: 16px;">
                                                            <a href="aboutkanchipuram.html" class="links">Kanchi At A Glance</a></td>
                                                        <td style="width: 13%; border-right: 1px solid #ffffff; text-align: center; height: 16px;">
                                                            <a href="HistoricalSpots.aspx" class="links" >Historical Spots</a></td>         
                                                        <td style="width: 20%; border-right: 1px solid #ffffff; text-align: center; height: 16px;">
                                                            <a href="LegendaryPersonalities.aspx" class="links">Legendary Personalities</a></td>
                                                        <td style="width: 9%; border-right: 1px solid #ffffff; text-align: center; height: 16px;">
                                                            <a href="Festivals.aspx" class="links">Festivals</a></td>
                                                        <td style="width: 11%; border-right: 1px solid #ffffff; text-align: center; height: 16px;">
                                                            <a href="touristinfo.html" class="links">Tourist Info</a></td>
                                                        <td style="width: 14%;  text-align: center; height: 16px;">
                                                            <a href="Glossary.aspx" class="links">Glossary</a></td>
