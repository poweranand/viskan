<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="HistoricalSpots.aspx.cs"
                ...
                <tr>
                    <td align="center">
                        <table border="0" cellpadding="0" cellspacing="0" width="1000px">
                                ...
                                <td style="background-image: url('Images/Linkbg.png'); background-position: center;
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                                <a href="aboutkanchipuram.html" class="links">Kanchi At A Glance</a>                                            </td>
												<td style="width: 13%; border-right: 1px solid #ffffff; text-align: center;">
                                                <a href="HistoricalSpots.aspx" class="links" style="color: Yellow;">Historical Spots</a>                                            </td>
                            ...
                            <tr>
                                <td valign="top" style="height: 2193px">
                                                    ...
                                                    <ContentTemplate>
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <td align="left" style="width:253px" >  
                                                               ...
                                                               <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ShowHeader="False" BorderWidth="0px" RowStyle-BorderWidth="0px" AlternatingRowStyle-BorderWidth="0" EditRowStyle-BorderWidth="0" EmptyDataRowStyle-BorderWidth="0" FooterStyle-Width="0" Width="254px" >
                                                                   ...
                                                                   <Columns>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">                                                                            
                                                                              <asp:ImageButton ID="grdImg1" width="254"  height = "180" BorderWidth="0" runat="server" ImageUrl='<%# bind("Mappath") %>' Onclientclick = "return LoadDiv(this.src);"/></table>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                        ...
                                                        <td valign="top">
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                                            ...
                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                ...
                                                                                                <tr id="tr2" runat="server" visible="false">
                                                                                                    <td align="left" class="txt" style="padding-right: 8px;" valign="top">
                                                                                                        ...
                                                                                                        <asp:Label Visible="false" ID="lblLocationVal" runat="server"></asp:Label>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="tr3" runat="server" visible="false">
                                                                                                    <td align="left" class="txt" style="padding-right: 8px;" valign="top">
                                                                                                        ...
                                                                                                        <asp:Label ID="lblArchitectureVal" runat="server" Visible="false"></asp:Label>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="tr4" runat="server" visible="false">
                                                                                                    <td align="left" class="txt" style="padding-right: 8px;" valign="top">
                                                                                                        ...
                                                                                                        <asp:Label ID="lblSculptureVal" runat="server" Visible="false"></asp:Label>
                                                                                                    </td>
                                                                                                </tr>
                                                                    ...
                                                                    <td style="width: 224px;  padding-left: 7px;" valign="top">
                                                                        <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
                                                                            <ContentTemplate>
                                                                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                           <td align="center">
                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-image:url(Images/Side.png); background-position:top; background-repeat:no-repeat;">
                                                                                                    <tr>
                                                                                                            ...
                                                                                                            <ItemTemplate>
                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                    <tr>
                                                                                                                     ...
                                                                                                                     <tr>
                                                                                                                        <td>
                                                                                                                             <asp:ImageButton ID="grdImg" Width="222px" Height="225px" BorderWidth="0" runat="server" ImageUrl='<%# bind("title") %>' Onclientclick = "return LoadDiv(this.src);"/>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                     <tr>
                                                                                                                        <td class="txt">
